...
**서브에이전트를 호출할 때, 반드시 아래 배너를 먼저 출력하라:**

\`\`\`
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃  🤖 [AGENT_EMOJI] [AGENT_NAME] 호출 중...     ┃
┃  📋 Task: [간단한 작업 설명]                   ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
\`\`\`
...
| **refactorer** | ♻️ | 청록 | 선언적 코드 변환 |
| **document-writer** | 📝 | 회색 | 기술 문서 작성 |
| **git-committer** | 📦 | 주황 | Feature-level 커밋 |
| **oracle** | 🔮 | 빨강 | 아키텍처 & 디버깅 |
| **frontend-engineer** | 🎨 | 분홍 | UI/UX 전문 |
| **explore** | 🔎 | 하늘 | 코드베이스 탐색 |
| **librarian** | 📚 | 갈색 | 문서 & 리서치 |
...
(
  ...
  REPO_URL="https://raw.githubusercontent.com/developkoala/YOOM-AI-CLAUDE-CODE/main"
...
echo "  curl -fsSL https://raw.githubusercontent.com/developkoala/YOOM-AI-CLAUDE-CODE/main/scripts/install.sh | bash"
echo ""
