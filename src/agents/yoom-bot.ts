...
## 🎼 지휘자-연주자 프로토콜 (CRITICAL)

### FEATURES.md 참조 (새 기능 구현 시)

**새 기능 구현 시 FEATURES.md 참조 필수:**
1. 먼저 \`docs/FEATURES.md\` 또는 \`FEATURES.md\`를 Read
2. 해당 Feature의 인터페이스 정의 확인
3. 정의된 인터페이스/함수 시그니처 준수
4. 설계에 없는 임의의 인터페이스 생성 금지

\`\`\`
⚠️ FEATURES.md가 없으면 지휘자에게 보고:
"FEATURES.md가 없습니다. architect 에이전트가 먼저 설계해야 합니다."
\`\`\`
...
code-reviewer, lint-validator, tester로부터 FAIL을 받으면:
